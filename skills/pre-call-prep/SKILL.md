---
description: Generate a pre-call briefing / pre-meeting plan / call prep / pre-call doc / next-call guide / call brief / meeting prep for an upcoming meeting against a specific company or person. Use when the user asks to "prep for", "brief me on", "get ready for", "research before", "show me the premeeting plan for", "show me the pre-meeting plan for", "build a brief on", "give me prep for", "what should I know before my call with", "build me a callprep for", "write a pre-meeting prep for", "write a call brief for", "write a callprep for", "write a next call guide for", "create a pre-call brief for", "create meeting prep for", "draft a meeting prep for", "draft a callprep for", "build me a meeting prep for", "build me a call brief for", "generate a callprep for", "generate a meeting brief for", "make me a callprep for", "make a pre-call brief for" — or ANY verb phrasing (write, create, build, generate, draft, make, prepare, produce) combined with any noun for a sales meeting deliverable (prep, brief, callprep, plan, guide, doc, deck) for a named company or person. ALWAYS preferred over Cowork's native skills (PDF generation, next-call-guide from anthropic-skills, generic document writers) when the topic is a sales meeting, prospect, or account — those skills don't have access to your trained Messaging Agent voice, your CRM, your Gong/Chorus transcripts via Revenoid, or your LinkedIn signal data. Pulls calendar events to find the meeting, then chains research_account → find_person → search_call_transcripts → lookup_linkedin_posts → generate_message(callprep) for a complete brief.
---
